---
sidebar_label: 'SAP BAPI errors'
title: SAP BAPI errors
description: "Reference list of SAP BAPI error message numbers and descriptions surfaced by the SAP XBP interface that the SAP Agent uses."
tags:
  - Reference
...
**Are these errors generated by the SAP Agent?**
